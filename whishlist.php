            ...
            <div class="row product_inner_row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="product_pagination">
                        <div class="left_btn">
                            <a
                                href="whishlist.php?<?php if (isset($searchCate)) ?>search-cate=<?php echo $searchCate ?>&<?php if (isset($_GET['submit'])) ?>submit=<?php echo $_GET['submit'] ?>&page=<?php if ($page > 1) echo $page - 1;
                                                                                                                                                                                                                            else echo 1 ?>">
                        ...
                        <div class="right_btn">
                            <a
                                href="whishlist.php?<?php if (isset($searchCate)) ?>search-cate=<?php echo $searchCate ?>&<?php if (isset($_GET['submit'])) ?>submit=<?php echo $_GET['submit'] ?>&page=<?php if ($page < $number_of_pages) echo $page + 1;
                        ...
                        <div class="col-lg-4 col-md-4 col-6">
                            <div class="cake_feature_item">
                                <div class="cake_img">
                                    ...
                                    <div class="icon-whishlist">
                                        <a
                                            href="whishlist.php?id=<?= md5($product['whishlistId'] . 'chuyen-de-web-2') ?>">
