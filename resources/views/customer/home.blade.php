...
@section('content')
    ...
    <div id="slides-shop" class="cover-slides">
        <ul class="slides-container">
            ...
            <li class="text-left">
                <img src="{{ asset('images/' .$item->slide_image) }}" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">                   
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="{{ asset('images/' . $item->protype_image ) }}" alt=""/>
                        <a class="btn hvr-hover" href="{{ route('shop', $item->protype_name) }}">{{ $item->protype_name }}</a>
                    </div>
                </div>
                @endforeach
            </div>
    ...
    <div class="products-box">
        <div class="container">
            ...
            <div style="display: flex;justify-content: center;">{{ $feature_product->links() }}</div>
        </div>
    </div>
    <!-- Start Blog  -->
