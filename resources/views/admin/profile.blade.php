                  ...
                  <aside class="profile-nav col-lg-3">
                      <section class="panel">
                          ...
                          <ul class="nav nav-pills nav-stacked">
                              <li class="active"><a href="{{ route('adminProfile') }}"><i class="fa fa-user"></i> Profile</a></li>
                              <li><a href="{{ route('adminEditProfile') }}"> <i class="fa fa-edit"></i> Edit profile</a></li>
                          </ul>
                      </section>
                  </aside>
                  <aside class="profile-info col-lg-9">
                      <section class="panel">
                          <div class="panel-body bio-graph-info">
                              ...
                              <div class="row">
                                  <div class="bio-row">
                                      <p><span>Full Name </span>: {{ $person->full_name }}</p>
                                  </div>
                                  <div class="bio-row">
                                  ...
                                  <div class="bio-row">
                                      <p><span>Birthday</span>: {{ $person->date_of_birth }}</p>
                                  </div>
                                  <div class="bio-row">
