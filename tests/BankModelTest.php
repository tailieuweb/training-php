...
<<<<<<< HEAD
    ...
    // Test case testDeleteBankById Just Check function Delete
    public function testDeleteBankById1()
    {
        $bankModel = new BankModel();
        $id = -1;
        $bankModel->insertBankWithId($id, "Danh", 2000);
        $check = $bankModel->deleteBankById($id);
        if (
            $check == true
        ){
...
>>>>>>> 1-php-202109/2-groups/10-J/master-phpunit
     ...
     * Test DeleteBankById Function in BankModel - 'Danh' do this
     */
    // Test case testDeleteBankByIdOK
    public function testDeleteBankByIdOK()
    {
        $bank = new BankModel();
        $id = -1;
        $bank->insertBank($id, '1000');
        $check = $bank->deleteBankById($id);
        $findUser = $bank->getBankById($id);
        var_dump($findUser);
        if (
            $check == true &&
            count($findUser) == 0
    ...
    // Test case testDeleteBankByIdNg Just Check
