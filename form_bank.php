...
if (!empty($_GET['id'])) {
    $_id = $_GET['id'];
    $bank = $bankModel->findUserById($_id);//Update existing user
            ...
            <?php if ($bank || !isset($_id)) { ?>
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="user_id" placeholder="Name" value='<?php if (!empty($bank[0]['user_id'])) echo $bank[0]['user_id'] ?>'>
                    </div>
                    <div class="form-group">
