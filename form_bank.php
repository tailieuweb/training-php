            ...
            <?php if ($bank || !isset($_id)) { ?>
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="name" value='<?php if (!empty($bank[0]['name'])) echo $bank[0]['name'] ?>' readonly>
                    </input>
                    <div class="form-group">
                        <label for="cost">Cost</label>
                        <input type="cost" name="cost" class="form-control" value='<?php if (!empty($bank[0]['cost'])) echo $bank[0]['cost'] ?>'> 
                    </div>
