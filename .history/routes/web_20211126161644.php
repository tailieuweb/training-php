...
Route::group(['module' => 'dashboard', 'middleware' => 'web', 'namespace' => "App\Http\Controllers"], function () {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::group(["prefix" => "favorite"], function () {
            Route::get("admin/", ["as" => "admin.favorite", "uses" => "LocationController@getAllLocation"]);
            Route::get("add", ["as" => "admin.favorite.add", "uses" => "LocationController@AddLocation"]);
            Route::post("save", ["as" => "admin.favorite.add", "uses" => "LocationController@getSaveLocation"]);
            Route::get("delete/{id}", ["as" => "admin.favorite.delete", "uses" => "LocationController@DeleteLocation"]);
            Route::get("edit/{id}", ["as" => "admin.favorite.edit", "uses" => "LocationController@EditLocation"]);
            Route::post("update/{id}", ["as" => "admin.favorite.eidt", "uses" => "LocationController@UpdateLocation"]);
        });
