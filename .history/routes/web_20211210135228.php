...
Route::group(['module' => 'dashboard', 'middleware' => 'web', 'namespace' => "App\Http\Controllers"], function () {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::group(["prefix" => "admin/comment"], function () {
            Route::get("/", ["as" => "admin.comment", "uses" => "CommentController@getAllFavorite"]);
            Route::get("/add", ["as" => "admin.comment.add", "uses" => "CommentController@createFavorite"]);
            Route::post("/add", ["as" => "admin.comment.save", "uses" => "CommentController@insertFavorite"]);
            Route::get("delete/{id}", ["as" => "admin.comment.delete", "uses" => "CommentController@deleteFavorite"]);
            Route::get("update/{id}", ["as" => "admin.comment.edit", "uses" => "CommentController@getUpdateFavorite"]);
            Route::post("update/{id}", ["as" => "admin.comment.eidt", "uses" => "CommentController@postUpdateFavorite"]);
        });
