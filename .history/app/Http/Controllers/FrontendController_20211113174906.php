...
class FrontendController extends Controller
{
    ...
    public function getDetailHotel($id)
    {
        ...
        $cmt = $this->getCommentHotel(Auth::user()->id, $all_hotel->hotel_id);
        var_dump(Session::get('user_id'));die();
    ...
    //Get comment of user for hotel rental
    public function getCommentHotel($user_id, $hotel_id){
        $this->AuthLogin();
        //check customer has booked this hotel
        if($this->checkRentalHotel($hotel_id, $user_id) == true){
            Session::put('user_id', $hotel_id);
        }
        else{
