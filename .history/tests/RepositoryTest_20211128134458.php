...
class RepositoryTest extends TestCase
{
     ...
     * Id is float
     */
    public function testGetFullUserIdFloat()
    {
        $repo = new Repository();
        $user_id = 1.4;
     ...
     * Full name is int
     */
    public function testCreateFullUserFullNameInt(){
        $repo = new Repository();
        $input = [];
        $input['name'] = "124";
        $input['fullname'] = 123;
     ...
     * Email is int
     */
    public function testCreateFullUserEmailInt(){
        $repo = new Repository();
        $input = [];
        $input['name'] = "124";
        $input['fullname'] = "123";
     ...
     * Pass is int
     */
    public function testCreateFullUserPassInt(){
        $repo = new Repository();
        $input = [];
        $input['name'] = "124";
        $input['fullname'] = "123";
