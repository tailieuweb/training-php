...
<body class="nav-md">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <div class="fa-hover col-md-3 col-sm-4  "><a onclick="setValueDelete(2)"><i class="fa fa-trash"></i></a>
                            </div>
  ...
  <script>
    function setValueDelete(id) {
      ...
      if (r == true) {
        window.location = '{{asset('')}}admin/favorite/delete/<?php echo $key; ?>' + this->id
      } else {
