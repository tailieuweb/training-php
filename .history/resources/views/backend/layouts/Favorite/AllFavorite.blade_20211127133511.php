...
<body class="nav-md">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <div class="fa-hover col-md-3 col-sm-4  "><a onclick="<?php $id_new = $favorite->favorite_id; ?>setValueDelete()"><i class="fa fa-trash"></i></a>
                            </div>
  ...
  <script>
    function setValueDelete() {
      ...
      if (r == true) {
        window.location = '{{asset('')}}admin/favorite/delete/<?php echo $key.$id_new; ?>'
      } else {
