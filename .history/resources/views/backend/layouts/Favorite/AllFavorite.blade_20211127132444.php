                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <div class="fa-hover col-md-3 col-sm-4  "><a onclick="setValueDelete()" href="{{asset('')}}admin/favorite/delete/<?php echo $key; ?>{{$favorite->favorite_id}}"><i class="fa fa-trash"></i></a>
                            </div>
