...
<body class="nav-md">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <div class="fa-hover col-md-3 col-sm-4  "><a onclick="comfirm('Bạn có chắc muốn xóa sản phẩm này không?')" href="{{asset('')}}admin/favorite/delete/<?php echo $key; ?>{{$favorite->favorite_id}}"><i class="fa fa-trash"></i></a>
                            </div>
  ...
  <script>
    function setValueDelete() {
      ...
      if (r == true) {
        window.location = 'http://php.local/public/admin/favorite'
      } else {
        window.location = '{{asset('')}}admin/favorite/delete/<?php echo $key; ?>{{$favorite->favorite_id}}'
      }
