...
<section class="container tm-detail-section">
    ...
    <div class="row justify-content-center">
        ...
        <div class="review-parent pills pt-3">
            <div class="row">
                <div class="col-md-7">
                    <h3 class="head">{{ count($comment) }} Reviews</h3>
                        ...
                        <div class="desc w-100">
                            ...
                            <form id="user-comment" method="POST" action="#" class="request-form">
                                ...
                                <div class="form-group">
                                    <input id="rating" type="number" value="" name="rating">
    ...
    <div class="col-md-4">
        <form method="POST" action="{{asset('')}}payment/{{$all_hotel->hotel_id}}" class="form_book detail" style="margin-top: 0!important;padding: 20px !important;border: 1px solid #000;">
        @csrf    
        <div class="w-100">
