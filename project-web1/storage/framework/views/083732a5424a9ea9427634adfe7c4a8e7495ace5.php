...
<section class="container tm-detail-section">
    ...
    <?php $key = rand(111111111,999999999); ?>
        <form method="GET" action="<?php echo e(asset('')); ?>payment/<?php echo e($key); ?><?php echo e($all_hotel->hotel_id); ?>" class="form_book detail" style="margin-top: 0!important;padding: 20px !important;border: 1px solid #000;">
            <div class="w-100">
...
<?php echo $__env->make('frontend.index-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\project-nhom-C-chuyen-de-web1\project-web1\resources\views/Frontend/layout/hotel/detail.blade.php ENDPATH**/ ?>