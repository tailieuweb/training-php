                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      ?>
                        ...
                        <!-- <td><?php echo e($loop->index + 1); ?></td> -->
                          <!-- <td><img src="assets/img/product/<?php echo e($pro->image); ?>" height="100" width="100" alt=""></td> -->
                       
                          <td><?php echo e($hotel->name); ?></td>
                          <!-- <td><?php echo e($hotel->price); ?></td>
                          <td><?php echo e($hotel->type_name); ?></td>
                          <td><?php echo e($hotel->manu_name); ?></td>
                          <td><?php echo e($hotel->description); ?></td>
                          <td><?php echo e($hotel->sale); ?></td>
                          <td><?php echo e($hotel->size); ?></td>
                          <td><?php echo e($hotel->gender); ?></td> -->
                          <td><?php echo e($hotel->created_at); ?></td>
                          <td><?php echo e($hotel->updated_at); ?></td>
                          <td >
                          <div class="fa-hover col-md-3 col-sm-4  "><a href="<?php echo e(URL::to('/admin/editproduct/'.$pro->id)); ?>"><i class="fa fa-wrench"></i></a>
                            
                              <div class="fa-hover col-md-3 col-sm-4  "><a onclick="return comfirm('Bạn có chắc muốn xóa sản phẩm này không?')" href="<?php echo e(URL::to('/admin/deleteproduct/'.$pro->id)); ?>"><i class="fa fa-trash"></i></a>
                        </div>
...
</html><?php /**PATH C:\wamp64\www\project-nhom-C-chuyen-de-web1\project-web1\resources\views/backend/layouts/AllHotels.blade.php ENDPATH**/ ?>