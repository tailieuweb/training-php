                  ...
                  <div class="card-box table-responsive">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        $stt = 1;
                        ?>
                        <?php $__currentLoopData = $favorite; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $favorite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo e($favorite->id); ?></td>
                          <td><?php echo e($favorite->name); ?></td>

                          <td>
                            <!-- <div class="fa-hover col-md-3 col-sm-4  "><a href="<?php echo e(URL::to('/favorite/edit/'.$key.$favorite->id)); ?>"><i class="fa fa-wrench"></i></a> -->

                              <div class="fa-hover col-md-3 col-sm-4  "><a onclick="return comfirm('Bạn có chắc muốn xóa sản phẩm này không?')" href="<?php echo e(URL::to('/favorite/delete/'.$key.$favorite->favorite_id)); ?>"><i class="fa fa-trash"></i></a>
                              </div>
...
</html><?php /**PATH C:\wamp64\www\project-nhom-C-chuyen-de-web1\project-web1\resources\views/backend/layouts/Favorite/AllFavorite.blade.php ENDPATH**/ ?>