                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo e($categories->categories_id); ?></td>
                          <td><?php echo e($categories->categories_name); ?></td>

                          <td>
                            <div class="fa-hover col-md-3 col-sm-4  "><a href="<?php echo e(URL::to('/categories/edit/'.$key.$categories->categories_id)); ?>"><i class="fa fa-wrench"></i></a>

                              <div class="fa-hover col-md-3 col-sm-4  "><a onclick="return comfirm('Bạn có chắc muốn xóa sản phẩm này không?')" href="<?php echo e(URL::to('/categories/delete/'.$key.$categories->categories_id)); ?>"><i class="fa fa-trash"></i></a>
                              </div>
...
</html><?php /**PATH C:\wamp64\www\project-nhom-C-chuyen-de-web1\project-web1\resources\views/backend/layouts/Categories/AllCategories.blade.php ENDPATH**/ ?>