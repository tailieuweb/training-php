...
<head>
    ...
    <title>Thêm Location | Pos Coron! </title>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="" action="<?php echo e(URL::to('/location/save')); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="address" placeholder="...." required="required" />
                                    </div>
                                </div>
                                <!-- <div class="field item form-group">
...
</html><?php /**PATH C:\wamp64\www\project-nhom-C-chuyen-de-web1\project-web1\resources\views/backend/layouts/Location/addLocation.blade.php ENDPATH**/ ?>