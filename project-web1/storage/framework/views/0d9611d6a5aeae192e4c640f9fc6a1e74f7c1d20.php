            ...
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="" action="<?php echo e(URL::to('/users/update/'.$user->id)); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" value="<?php echo e($user->name); ?>" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="Giày ...." required="required" />
                                </div>
                            </div>
                            <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Email<span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" value="<?php echo e($user->email); ?>" class='price' name="email" type="email" />
                                    </div>
                                </div>
                                <div class="field item form-group">
...
</html><?php /**PATH C:\wamp64\www\project-nhom-C-chuyen-de-web1\project-web1\resources\views/backend/layouts/Users/editUser.blade.php ENDPATH**/ ?>