                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo e($rating->rating_id); ?></td>
                          <td><?php echo e($rating->name); ?></td>
                          <td><?php echo e($rating->content); ?></td>

                          <td>
                           

                              <div class="fa-hover col-md-3 col-sm-4  "><a onclick="return comfirm('Bạn có chắc muốn xóa sản phẩm này không?')" href="<?php echo e(URL::to('/rating/delete/'.$key.$rating->rating_id)); ?>"><i class="fa fa-trash"></i></a>
                              </div>
...
</html><?php /**PATH C:\wamp64\www\project-nhom-C-chuyen-de-web1\project-web1\resources\views/backend/layouts/Rating/AllRating.blade.php ENDPATH**/ ?>