                      ...
                      ?>
                        ...
                        <!-- <td><?php echo e($loop->index + 1); ?></td> -->
                          ...
                          <div class="fa-hover col-md-3 col-sm-4  "><a href="<?php echo e(URL::to('/hotels/edithotel/'.$key.$hotel->hotel_id)); ?>"><i class="fa fa-wrench"></i></a>
                              ...
                              <div class="fa-hover col-md-3 col-sm-4  "><a onclick="return comfirm('Bạn có chắc muốn xóa sản phẩm này không?')" href="<?php echo e(URL::to('/hotels/deletehotel/'.$key.$hotel->hotel_id)); ?>"><i class="fa fa-trash"></i></a>
                        </div>
...
</html><?php /**PATH C:\wamp64\www\project-nhom-C-chuyen-de-web1\project-web1\resources\views/backend/layouts/Hotel/AllHotels.blade.php ENDPATH**/ ?>