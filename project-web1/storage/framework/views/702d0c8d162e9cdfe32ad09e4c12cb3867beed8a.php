            ...
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="" action="<?php echo e(URL::to('/categories/update/'.$categories->categories_id)); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" value="<?php echo e($categories->categories_name); ?>" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="Giày ...." required="required" />
                                </div>
                            </div>
...
</html><?php /**PATH C:\wamp64\www\project-nhom-C-chuyen-de-web1\project-web1\resources\views/backend/layouts/Categories/editCategories.blade.php ENDPATH**/ ?>