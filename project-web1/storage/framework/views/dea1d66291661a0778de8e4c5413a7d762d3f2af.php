            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="" action="<?php echo e(URL::to('/users/save')); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\wamp64\www\project-nhom-C-chuyen-de-web1\project-web1\resources\views/backend/layouts/Users/addUser.blade.php ENDPATH**/ ?>