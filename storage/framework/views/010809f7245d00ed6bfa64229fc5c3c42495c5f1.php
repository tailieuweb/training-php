                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo">
                                    <a href="<?php echo e(asset('/')); ?>"><img src="<?php echo e(url('frontend/images/logo.png')); ?>" alt="#" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="collapse navbar-collapse" id="navbarsExample04">
                                ...
                                <div class="dropdown">
                                    <div class="name_user"><a href="#" class="dropdown-toggle nav-link" type="button"
                                            ...
                                            aria-label="Toggle navigation"><?php echo e(Auth::user()->username); ?></a></div>
                                    <div class="dropdown-menu" aria-labelledby="user_rental" id="navbarsExample06">
                                        <a class="dropdown-item" href="#">Profile</a>
                                        <a class="dropdown-item" href="<?php echo e(route('admin.favorite')); ?>">Favorite</a>
                                        <a class="dropdown-item" href="<?php echo e(route('frontend.logout.index')); ?>">Logout</a>
                                    </div>
                                </div>
                            </div>
                        </nav>
 ...
 <header>
                  ...
                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           ...
                           <div class="sign_btn"><a href="<?php echo e(asset('login/user')); ?>">Sign in</a></div>
                        </div>
                     </nav>
                  </div>
               </div>
      ...
      <!-- end header -->
 <?php endif; ?>
<?php /**PATH C:\Users\ASUS\Music\project-nhom-C-chuyen-de-web1\project-web1\resources\views/frontend/partial/header.blade.php ENDPATH**/ ?>